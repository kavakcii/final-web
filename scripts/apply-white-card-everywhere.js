...
async function applyWhiteCardEverywhere() {
  ...
  // Overwrite EVERY icon path with the solid white card centered blue F logo PNG
  ...
  await browser.close();
  console.log('SUCCESS: Every single icon path updated with solid white card centered logo!');
}

applyWhiteCardEverywhere().catch(err => {
