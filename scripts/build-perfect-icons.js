...
async function buildPerfectIcons() {
  ...
  // Perfect centering & bold sizing (85% fill) on 512x512 canvas
  const html = `
    <!DOCTYPE html>
    <html>
      <head>
  ...
  await browser.close();
  console.log('SUCCESS: Generated perfectly centered & bold 512x512 icons!');
}

buildPerfectIcons().catch(err => {
