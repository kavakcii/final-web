...
function AssetLogo({ symbol, className = "w-10 h-10" }: { symbol: string; className?: string }) {
    ...
    const logoSlugMap: Record<string, string> = {
        ...
        "HLGYO": "halk-gmyo", "KLGYO": "kiler-gmyo", "SNGYO": "sinpas-gmyo",
        "VKGYO": "vakif-gmyo", "OZKGY": "ozak-gmyo", "PSGYO": "pasifik-gmyo",
        "MSGYO": "mistral-gmyo", "ISGYO": "is-gmyo", "TRGYO": "torunlar-gmyo",
        "ALGYO": "alarko-gmyo", "EKGYO": "emlak-konut-gmyo", "SOKM": "sok-marketler",
        "VESTL": "vestel", "VESBE": "vestel-beyaz-esya", "PETKM": "petkim",
        "KRDMD": "kardemir", "ALARK": "alarko-holding", "TKFEN": "tekfen",
        "HALKB": "halkbank", "VAKBN": "vakifbank", "AEFES": "anadolu-efes",
        "CCOLA": "coca-cola-icecek", "ULKER": "ulker", "ANSGR": "anadolu-sigorta",
        "TURSG": "turkiye-sigorta", "ALTNY": "altinay-savunma", "OTKAR": "otokar",
        "DOAS": "dogus-otomotiv", "PATEK": "pasifik-teknoloji", "ARDYZ": "ard-bilisim",
        "BRSAN": "borusan", "SDTTR": "sdt-uzay", "TAVHL": "tav-havalimanlari",
        "ENJSA": "enerjisa", "ODAS": "odas-elektrik", "KONTR": "kontrolmatik",
        "CWENE": "cw-enerji", "EUPWR": "europower", "GESAN": "girisim-elektrik",
        "REEDR": "reeder", "ZGYO": "z-gayrimenkul", "MEYSU": "meysu",
        "ARFYE": "arf-bio", "ZERGY": "zeray-gyo", "PAHOL": "pasifik-holding",
        "ECOGR": "ecogreen", "MARMR": "marmara-holding", "DOFRB": "dof-robotik",
        "BULGS": "bulls-girisim", "ATATR": "ata-turizm", "BESTE": "best-brands",
        "AKHAN": "akhan-un", "NETCD": "netcad"
    };
...
const ASSET_NAMES: Record<string, string> = {
    ...
    ARFYE: "Arf Bio Yenilenebilir Enerji A.Ş.",
    MEYSU: "Meysu Gıda San. ve Tic. A.Ş.",
    ATATR: "Ata Turizm İşletmecilik A.Ş.",
    BESTE: "Best Brands Grup Enerji A.Ş.",
    AKHAN: "Akhan Un Fabrikası A.Ş.",
                                                                ...
                                                                <td className="py-4 px-6 text-right">
                                                                    <div className="flex items-center justify-end gap-1.5 flex-wrap sm:flex-nowrap">
                                                                        <button 
                                                                            ...
                                                                            title={`${group.symbol} varlık alımı yap`}
                                                                        >
                                                                        ...
                                                                        <button 
                                                                            ...
                                                                            title={`${group.symbol} varlığını sil (pozisyon kaydını kaldır)`}
                                                                        >
