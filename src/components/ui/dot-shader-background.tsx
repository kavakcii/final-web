...
const DotMaterial = shaderMaterial(
  ...
  /* glsl */ `
    ...
    void main() {
        bool isDefault = dotColor.r == 1.0 && dotColor.g == 1.0 && dotColor.b == 1.0;
...
// Extend R3F catalog essentially for types
...
function Scene() {
    ...
    const getThemeColors = () => {
        // Force dark theme colors as per user context or implement real theme logic
        // Using deep blue/black from globals.css: #020617
        // Dot color: slightly lighter blue/white
        return {
    ...
    // We need to cast it because shaderMaterial returns a class that extends ShaderMaterial but TS doesn't infer uniform types automatically on the instance perfectly for 'uniforms' property access pattern often used in bare three.js, 
    // but in R3F we usually update props. 
    // However, the original code uses uniforms.value update pattern.
...
export const DotScreenShader = () => {
    return (
        <div className="fixed inset-0 w-full h-full -z-10 bg-slate-950 pointer-events-none">
