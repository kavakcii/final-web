...
export function FinAiYesterdayReportWidget() {
    ...
    return (
        <div className="bg-white border border-slate-200/90 hover:border-[#00008B]/25 rounded-3xl p-5 sm:p-6 shadow-xs hover:shadow-md transition-all duration-300 min-h-[310px] flex flex-col justify-between group">
            ...
            <div className="flex items-center justify-between gap-2 pt-2.5 pb-1 flex-wrap">
                ...
                {myAssets.length > 0 && !loading && (
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black text-[#00008B] bg-blue-50 px-2 py-0.5 rounded-lg border border-blue-200/60 flex items-center gap-0.5" title="Time-Weighted Return">
            ...
            {/* 3. Ana Açıklama Alanı (Referans Görseldeki Vurgulu Kart Tasarımı) */}
            <div className="my-auto py-1">
                {loading ? (
                    <div className="py-8 flex flex-col items-center justify-center gap-2 text-center">
                        <Loader2 className="w-5 h-5 text-[#00008B] animate-spin" />
                        <span className="text-[11px] font-bold text-slate-400">Finansal rapor analiz ediliyor...</span>
                    </div>
                ) : (
                    <div className="p-3.5 rounded-2xl bg-gradient-to-r from-blue-50/60 via-slate-50/50 to-indigo-50/40 border border-blue-100/70 shadow-2xs space-y-2">
                        <div className="flex items-center gap-2">
                            <div className="w-6 h-6 rounded-lg bg-[#00008B] text-white flex items-center justify-center shrink-0">
                        ...
                        <p className="text-xs sm:text-[12.5px] font-medium leading-relaxed text-slate-700 line-clamp-3">
                            {narrativeToDisplay}
                        </p>
                    </div>
                )}
            ...
            <div className="pt-2.5 border-t border-slate-100 flex items-center justify-between">
                ...
                <Link
                    href="/dashboard/reports"
                    className="inline-flex items-center gap-1.5 px-3 py-1 bg-white hover:bg-slate-50 border border-slate-200 text-[#00008B] text-[11px] font-bold rounded-xl shadow-2xs transition-all hover:scale-105 active:scale-95"
                >
