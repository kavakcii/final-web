...
export default function Footer() {
    return (
        <footer className="bg-[#00008B] border-t border-blue-900 mt-auto text-slate-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="mt-8 pt-8 border-t border-blue-800/50 text-center text-sm text-slate-500">
