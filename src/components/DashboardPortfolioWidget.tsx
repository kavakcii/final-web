...
export function DashboardPortfolioWidget() {
    ...
    if (isLoading) {
        return (
            <div className="lg:col-span-2 bg-[radial-gradient(ellipse_at_center,_#ffffff_0%,_rgba(10,25,47,0.12)_120%)] ring-1 ring-[#0a192f]/5 shadow-[0_15px_30px_-15px_rgba(0,0,0,0.06)] rounded-[1.5rem] p-8 flex items-center justify-center min-h-[300px]">
