        ...
        <div className="p-6 space-y-8 animate-in fade-in duration-500 max-w-7xl mx-auto relative min-h-screen">
            ...
            <AnimatePresence>
                {!isDataLoaded && (
                    ...
                    >
                        <div className="w-full max-w-md p-8 rounded-[2rem] bg-[radial-gradient(ellipse_at_center,_#ffffff_0%,_rgba(30,64,175,0.12)_100%)] ring-1 ring-[#0a192f]/5 shadow-[0_30px_60px_-20px_rgba(0,0,0,0.12)] relative overflow-hidden text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {(!isDataLoaded ? Array(3).fill(null) : stats).map((stat, index) => (
                    <motion.div
                        ...
                        className={cn(
                            "bg-[radial-gradient(ellipse_at_center,_#ffffff_0%,_rgba(30,64,175,0.12)_100%)] ring-1 ring-[#0a192f]/[0.08] hover:ring-[#0a192f]/15 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] rounded-[1.5rem] p-6 relative overflow-hidden group transition-all duration-500 hover:-translate-y-1 shadow-sm"
                        )}
                    >
                        {!isDataLoaded ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-[radial-gradient(ellipse_at_center,_#ffffff_0%,_rgba(30,64,175,0.12)_100%)] ring-1 ring-[#0a192f]/[0.1] shadow-[0_15px_30px_-15px_rgba(0,0,0,0.06)] rounded-[1.5rem] p-7 flex flex-col relative overflow-hidden transition-all duration-500 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)]">
